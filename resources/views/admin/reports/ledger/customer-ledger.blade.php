...
<x-app-layout>
       <div class="widget mt-3" id="print-widget">
            ...
            <div class="widget-head">
                <div class="d-flex align-items-center flex-wrap">
                    ...
                    <div class="ms-auto print-none">
                        ...
                        <a href="{{ route('ledger.customer-ledger') }}" class="btn btn-sm  btn-primary" title="Reload page">
                          <x-icons.refresh/>
                        </a>
                    </div>
                </div>
            ...
            <div class="widget-body">
                 <!-- search area -->
                <div class="print-none {{ request()->search ? 'show' : '' }}" id="customerLedger-search">
                                ...
                                <div class="col-3">
                                    ...
                                    <select id="select-name" placeholder="... Choose one ..." autocomplete="off" name="customer_id">
                                        ...
                                        @foreach ($customers as $customer )
                                            <option {{ request()->search ? request()->customer_id == $customer->id ? 'selected' : '' : '' }} value="{{$customer->id}}">{{$customer->name}}
                                ...
                                <tr>
                                    ...
                                    <td colspan="4" class="text-end">
                                        ...
                                        @if($total_debit > $total_credit)
                                            @php
                                                $opening_balance = $customer_balance - ($total_debit - $total_credit) ;
                                                $balance = $opening_balance;
                                            @endphp
                                        @else
                                            @php
                                                $opening_balance = $customer_balance + ($total_credit - $total_debit) ;
                                                $balance = $opening_balance;
                                            @endphp
                                        @endif
                                ...
                                <tr>
                                    ...
                                    <td class="text-wrap">
                                        ...
                                        @elseif ($ledger->type === 'due_manage')
                                            <p>Due Manage</p>
                                        @elseif ($ledger->type === 'monthly_recharge')
                                            <p>Monthly charge</p>
                                        @else
                                        <p></p>
                                        @endif
                                    ...
                                    <td class="text-end">
                                        ...
                                        @elseif ($ledger->type === 'monthly_recharge')
                                            <p>{{ (($ledger->amount) ? number_format($ledger->amount, 2) : number_format(0, 2)) }}</p>
                                        @else
                                            <p></p>
                                        @endif
                                    </td>
