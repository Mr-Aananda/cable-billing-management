    ...
    <div class="col-md-12">
        <div class="widget mt-3">
             <div class="widget-head">
                <div class="d-flex align-items-center flex-wrap">
                    <div class="mt-0">
                        <h4 class="main-title">Create new product</h4>
                        <p><small>Can create <strong>product</strong> from here.</small></p>
                    </div>
            ...
            <div class="widget-body">
                ...
                <form action="{{ route('product.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-5">
                            <input type="text" name="model" value="{{ old('model')}}" class="form-control @error('model') is-invalid @enderror"  id="model" placeholder="Enter model">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-5">
                            <input type="number" name="purchase_price" value="{{ old('purchase_price')}}" class="form-control @error('purchase_price') is-invalid @enderror"  id="purchase-price" min="0" placeholder="0.00" required>
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-5">
                            <input type="number" name="sale_price" value="{{ old('sale_price')}}" class="form-control @error('sale_price') is-invalid @enderror"  id="sale-price" min="0" placeholder="0.00" required>
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-5">
                            <input type="number" name="stock_alert" value="{{ old('stock_alert')}}" class="form-control @error('stock_alert') is-invalid @enderror"  id="stock-alert" min="0" placeholder="0.00">
