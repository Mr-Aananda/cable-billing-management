        ...
        <div class="widget-body">
            ...
            <div class="d-flex align-items-center flex-wrap">
                <nav aria-label="breadcrumb">
                    {{ Breadcrumbs::render('expense edit',$expense) }}
                </nav>
    ...
    <div class="col-md-12">
        <div class="widget mt-3">
             <div class="widget-head">
                <div class="d-flex align-items-center flex-wrap">
                    <div class="mt-0">
                        <h4 class="main-title">Edit old expense</h4>
                        <p><small>Can edit <strong>expense</strong> from here.</small></p>
                    </div>
            </div>
            <div class="widget-body">
                ...
                <form action="{{ route('expense.update', $expense->id) }}" method="POST">
                    ...
                    <!-- type text -->
                     <div class="mb-3 row">
                        ...
                        <div class="col-4">
                            <input type="date" name="date" value="{{ old('date',$expense->date)}}" class="form-control @error('date') is-invalid @enderror" id="date" required>
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-4">
                            <div class="input-group">
                                ...
                                <input type="number" name="amount" value="{{ old('amount', $expense->amount)}}" step="any" min="0"
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-5">
                            <textarea name="note" class="form-control @error('note') is-invalid @enderror" id="note" rows="3"
                                placeholder="Optional">{{ old('note', $expense->note)}}</textarea>
