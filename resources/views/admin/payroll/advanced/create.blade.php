        ...
        <div class="widget-body">
            ...
            <div class="d-flex align-items-center flex-wrap">
                <nav aria-label="breadcrumb">
                    {{ Breadcrumbs::render('advanced create') }}
                </nav>

                <div class="ms-md-auto ms-0 btn-group">

                    <!-- header icon -->
                    <a href="{{ route('payroll-advanced.index') }}" title="Go back" class="print-none btn btn-sm btn-primary ms-auto">
                        <x-icons.back/>
                    </a>
    ...
    <div class="col-md-12">
        <div class="widget mt-3">
             <div class="widget-head">
                <div class="d-flex align-items-center flex-wrap">
                    <div class="mt-0">
                        <h4 class="main-title">Create new advanced</h4>
                        <p><small>Can create <strong>advanced salary</strong> from here.</small></p>
                    </div>
                </div>
            ...
            <div class="widget-body">
                ...
                <form action="{{ route('payroll-advanced.store') }}" method="POST">
                      @csrf
