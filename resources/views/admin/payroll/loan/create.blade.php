        ...
        <div class="widget-body">
            ...
            <div class="d-flex align-items-center flex-wrap">
                <nav aria-label="breadcrumb">
                    {{ Breadcrumbs::render('loan create') }}
                </nav>
    ...
    <div class="col-md-12">
        <div class="widget mt-3">
             <div class="widget-head">
                <div class="d-flex align-items-center flex-wrap">
                    <div class="mt-0">
                        <h4 class="main-title">Create new loan</h4>
                        <p><small>Can create <strong>loan</strong> from here.</small></p>
                    </div>
                </div>
            ...
            <div class="widget-body">
                ...
                <form action="{{ route('payroll-loan.store') }}" method="POST">
                      @csrf
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-5">
                            <input type="date" name="expire_date" value="{{ old('expire_date')}}" class="form-control  @error('expire_date') is-invalid @enderror" id="expire_date" required>
