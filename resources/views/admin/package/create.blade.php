    ...
    <div class="col-md-12">
        <div class="widget mt-3">
             <div class="widget-head">
                <div class="d-flex align-items-center flex-wrap">
                    <div class="mt-0">
                        <h4 class="main-title">Create new package</h4>
                        <p><small>Can create <strong>package</strong> from here.</small></p>
                    </div>
                </div>
            ...
            <div class="widget-body">
                ...
                <form action="{{ route('package.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-5">
                            <input type="number" name="price" value="{{ old('price')}}" class="form-control @error('price') is-invalid @enderror"  id="price" min="0" placeholder="0.00" required>
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-5">
                            <input type="number" name="cost" value="{{ old('cost')}}" class="form-control @error('cost') is-invalid @enderror"  id="cost" min="0" placeholder="0.00">
