    ...
    <div class="widget-body">
            <div class="d-flex align-items-center flex-wrap">
                ...
                <div class="ms-auto print-none">
                    <button type="button" class="btn btn-sm btn-secondary" data-bs-toggle="collapse" data-bs-target="#search">
                        <x-icons.chevron/>
                    </button>
                </div>
            </div>
            ...
            <div class="px-0 border-0 card card-body rounded-0">
                ...
                <form action="{{ route($route_name) }}" method="GET">
                    ...
                    <div class="row">
                        ...
                        <div class="col-2">
                            <label for="select-beast" class="form-label">Select customer</label>
                        ...
                        <div class="col-2">
                            <label for="name" class="form-label">Cable ID</label>
                            <input type="text" name="cable_id" value="{{ request()->cable_id }}" class="form-control"
