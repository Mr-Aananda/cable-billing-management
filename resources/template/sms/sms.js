...
function myFunction(e) {
   let template = (document.getElementById("template").value = e.target.value);
    message.value = template;
    let templateWordCount = template.length + 30;
    totalCharacters.value = templateWordCount;
...
message.addEventListener("input", function () {
    const count = message.value.length + 30;
