...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('supplier_due_manages', function (Blueprint $table) {
            $table->id();
            $table->foreignId('supplier_id')->constrained()->cascadeOnUpdate()->cascadeOnUpdate();
            $table->date('date');
    ...
    {
        Schema::dropIfExists('supplier_due_manages');
    }
};
